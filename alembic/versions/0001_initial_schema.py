...
def upgrade() -> None:
    ...
    with op.batch_alter_table("audit_logs", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_audit_logs_household_id"), ["household_id"], unique=False
        )
        batch_op.create_index(
    ...
    with op.batch_alter_table("persons", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "ix_persons_household_id_email", ["household_id", "email"], unique=False
        )
    ...
    with op.batch_alter_table("categories", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "ix_categories_household_id_parent_id", ["household_id", "parent_id"], unique=False
        )
    ...
    with op.batch_alter_table("entity_preferences", schema=None) as batch_op:
        batch_op.create_index(
            "ix_entity_preferences_person_id_entity_type",
            ["person_id", "entity_type"],
            unique=False,
        )
    ...
    with op.batch_alter_table("formulas", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_formulas_household_id"), ["household_id"], unique=False
        )
    ...
    with op.batch_alter_table("accounts", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_accounts_household_id"), ["household_id"], unique=False
        )
        batch_op.create_index(
            "ix_accounts_household_id_account_type", ["household_id", "account_type"], unique=False
        )
    ...
    with op.batch_alter_table("budgets", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "ix_budgets_category_id_period_start", ["category_id", "period_start"], unique=False
        )
        batch_op.create_index(batch_op.f("ix_budgets_household_id"), ["household_id"], unique=False)
        batch_op.create_index(
            "ix_budgets_household_id_period_start_end",
            ["household_id", "period_start", "period_end"],
            unique=False,
        )
    ...
    with op.batch_alter_table("account_snapshots", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_account_snapshots_account_id"), ["account_id"], unique=False
        )
        batch_op.create_index(
            "ix_account_snapshots_account_id_snapshot_date",
            ["account_id", "snapshot_date"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_account_snapshots_archived"), ["archived"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_account_snapshots_household_id"), ["household_id"], unique=False
        )
    ...
    with op.batch_alter_table("financial_events", schema=None) as batch_op:
        batch_op.create_index(
            "ix_fe_household_id_category_id", ["household_id", "category_id"], unique=False
        )
        batch_op.create_index(
            "ix_fe_household_id_event_date", ["household_id", "event_date"], unique=False
        )
        batch_op.create_index(
            "ix_fe_household_id_payee_person_id", ["household_id", "payee_person_id"], unique=False
        )
        batch_op.create_index(
        ...
        batch_op.create_index(
            batch_op.f("ix_financial_events_archived"), ["archived"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_financial_events_event_date"), ["event_date"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_financial_events_household_id"), ["household_id"], unique=False
        )
    ...
    with op.batch_alter_table("occurrence_records", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_occurrence_records_recurring_event_id"),
            ["recurring_event_id"],
            unique=False,
        )
        batch_op.create_index(
            "ix_occurrence_records_recurring_event_id_expected_date",
            ["recurring_event_id", "expected_date"],
            unique=False,
        )
