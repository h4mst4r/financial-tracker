...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('active', 'inactive', 'archived', name='statusenum'), nullable=False),
    sa.ForeignKeyConstraint(['archived_by'], ['persons.id'], ),
    sa.ForeignKeyConstraint(['asset_id'], ['accounts.id'], ),
    sa.ForeignKeyConstraint(['created_by'], ['persons.id'], ),
    ...
    op.create_index(op.f('ix_valuation_records_asset_id'), 'valuation_records', ['asset_id'], unique=False)
    op.create_index('ix_valuations_asset_date', 'valuation_records', ['asset_id', 'valuation_date'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_valuations_asset_date', table_name='valuation_records')
    op.drop_index(op.f('ix_valuation_records_asset_id'), table_name='valuation_records')
